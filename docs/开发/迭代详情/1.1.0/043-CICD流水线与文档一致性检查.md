...
- [ ] `pnpm check:docs` 命令可用，5 项检查全部通过
- [ ] `.github/workflows/ci.yml` 已创建，push/PR 时自动运行
- [ ] CI 中 build + lint + doc-consistency 三个 job 全绿
- [ ] `质量门控.md` 已更新，新增 CI 相关说明
- [ ] 如果 Prisma Schema 或 API 路由变更但文档未同步，`pnpm check:docs` 会报错
